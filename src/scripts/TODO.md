...
- [x] บอตที่คอยบันทึกการอัปโหลดข้ามวิกิจาก th.wikipedia.org ไปคอมมอนส์ แล้วบันทึกไว้ให้ผู้ใช้อื่นตรวจสอบง่าย ๆ 
  - มี [abusefilter](https://commons.wikimedia.org/wiki/Special:AbuseFilter/153)
- [x] บอตที่เก็บการอภิปรายเข้ากรุ
  - Run ด้วย python อยู่วันละครั้ง ไม่ได้ใช้ js
...
- [x] ถ้าตรวจเจอหมวดหมู่ในฉบับร่าง ให้ห่อไว้ใน {{หมวดหมู่ฉบับร่าง}}
- [x] แจ้งลบฉบับร่างที่ไม่ได้แก้ไขนานเกิน 6 เดือน แล้วแจ้งผู้สร้างว่าฉบับร่างกำลังจะถูกลบ
- [ ] เพิ่มแม่แบบ {{การใช้งานสูง}} ในแม่แบบที่มีการใช้งานมากกว่า 2000 ครั้ง
- [ ] นำบริการย้ายหมวดหมู่กลับมาอีกที
- [ ] เลิกการใช้แม่แบบ {{พรรค*/meta/color}} ไปใช้ {{สีพรรค|*}} แทน
- [ ] ลบการใช้ {{In use}} ที่การแก้ไขล่าสุดนานกว่า 12 ชม. ออก